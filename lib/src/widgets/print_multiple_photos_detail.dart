...
class _PrintPhotoWidgetState extends State<MultiplePhotosDetailWidget> {
  ...
  void initState() {
    ...
    if (!isNativeAdLoaded && adConfig.nativeSheet_2_4) {
      AdmobEasy.instance.initialize(
        androidNativeAdID: adConfig.nativeSheet_2_4Id,
      );
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              Spacer(),
              isNativeAdLoaded && adConfig.nativeSheet_2_4
                  ...
                  : adConfig.nativeSheet_2_4
                      ? ShimmerLoading(height: 100, width: 400)
                      : Container(),
              /*
         InkWell(
                onTap: () {},
